...
return [
    ...
    */
	...
	'after_or_equal' =>
		':attribute değeri :date tarihinden sonra veya eşit olmalıdır.',
	...
	'before_or_equal' =>
		':attribute değeri :date tarihinden önce veya eşit olmalıdır.',
	'between' => [
	...
	'digits_between' =>
		':attribute :min ile :max arasında haneden oluşmalıdır.',
	...
	'gte' => [
		...
		'file' =>
			':attribute, :value kilobayt boyutu kadar veya daha büyük olmalı.',
	...
	'lte' => [
		...
		'file' =>
			':attribute, :value kilobayt boyutu kadar veya daha küçük olmalı.',
